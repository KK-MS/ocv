...
int main(int argc, char *argv[])
{
  ...
  Mat whiteLane, yellowLane, LinesImg, HSV_Img, gray;
  ...
  while(1)
  {
	...
	int pix_lane = GT_D2L / PIXEL_DIST;
	int GT_point_lane_x = START_X + pix_lane;
	int GT_point_lane_y = START_Y;

	int ROI_x1 = GT_point_lane_x - 20;
	int ROI_y1 = GT_point_lane_y - 20;
